...
class WoodsMap extends WarMap {
  WoodsMap() : super(16, 9) {
    ...
    tileMap[1][6] = Tile(Wood());
    tileMap[2][6] = Tile(Plain());
    tileMap[3][6] = Tile(Wood());
    tileMap[4][6] = Tile(Wood());
    tileMap[5][6] = Tile(Wood());
    tileMap[6][6] = Tile.unit(Plain(), Mech.orange());
    ...
    tileMap[12][6] = Tile(Plain());
    tileMap[13][6] = Tile(Wood());
    tileMap[14][6] = Tile(Plain());
